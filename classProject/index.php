...
<html>
    ...
    <body>
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"]=="POST") {
                ...
                if($numrows == 1) {
                    ...
                    if($pw==$dbpw) { //if verify is true, forward them to user/admin home make both ecrypt & nonencrypt work
        ...
        <p>Feb 20:</p>
            <ul>
                <li>1. General User: Login & Take The Quizzes (Done)</li>
                <li>2. Admin User: Login & Manage the Website (Done)</li>
            </ul>
        <p>To Do:</p>
            <ol>
                <li>Update the database: need to add column: user_type (Done)</li>
                <li>Create admin_nav.php (Done)</li>
                <li>Create admin function to help manage the website (Done)</li>
            </ol>
        <p>March 12: User Functions</p>
            <ul>
                <li>User Login (Done)</li>
                <li>User Profile (Done)</li>
                <li>User Assessment (Done)</li>
                <li>Check Quiz Results (Done)</li>
            </ul>
            <ul>
                <li>Add columns in users table (Done)</li>
                <li>Create a php quiz form (Done)</li>
                <li>Submit form to the database (Done)</li>
            </ul>
            Homework: <br>
            1. Make all the quizzes work <br>
            2. Display quiz results in admin_display (Done)<br>
            <hr>
        <?php
